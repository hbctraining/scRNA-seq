...
Let's begin by **adding a column with our cell IDs** and **changing the current column names** to be more intuitive:
...
Now we need to calculate some additional metrics for plotting:
